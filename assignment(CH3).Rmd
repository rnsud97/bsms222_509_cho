...
```{r}
my_function <- function(VARIABLE_NAME){perform operations on VARIABLE_NAME and calculate VALUE
  VALUE
}
```
...
7.Write a function compute_s_n that for any given n computes the sum Sn=....
